...
/**
 *
 * Eventcon elementor home contact section widget.
 *
 * @since 1.0
 */
class Eventcon_Home_Contact extends Widget_Base {

	public function get_name() {
		return 'eventcon-home-contact';
	}

	public function get_title() {
		return __( 'Home Contact Section', 'eventcon-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Tour function information without cross action media value quickly maximize timely deliverables.', 'eventcon-companion' ),
            ]
        );
        $this->add_control(
            'form_shortcode',
            [
                ...
                'description' => esc_html__( 'Put your Contact form7 shortcode here.', 'eventcon-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
