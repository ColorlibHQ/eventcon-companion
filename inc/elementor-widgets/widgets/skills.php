...
/**
 *
 * Eventcon elementor skills section widget.
 *
 * @since 1.0
 */
class Eventcon_Skills extends Widget_Base {

	public function get_name() {
		return 'eventcon-skills';
	}

	public function get_title() {
		return __( 'My Skills', 'eventcon-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'skills_content',
			[
				'label' => __( 'Skills content', 'eventcon-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Section Title', 'eventcon-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default'   => esc_html__( 'I’m a Creative director based on New York, who loves clean, simple & unique design. I also enjoy crafting', 'eventcon-companion' ),
            ]
        );
        $this->add_control(
            'about_yourself',
            [
                'label' => esc_html__( 'About Yourself', 'eventcon-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Download CV', 'eventcon-companion' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Personal Image Section', 'eventcon-companion' ),
		...
		$this->add_control(
            'skills', [
                ...
                'fields' => [
                    [
                        'name' => 'item_title',
                        'label' => __( 'Skill Title', 'eventcon-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default'     => __( 'Wireframing', 'eventcon-companion' ),
                    ],
                    [
                        'name' => 'skill_val',
                        'label' => __( 'Skill Value', 'eventcon-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [ 
                        'item_title'    => __( 'Weightlifting', 'eventcon-companion' ),
                        'skill_val'   => __( '90', 'eventcon-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'UI/UX', 'eventcon-companion' ),
                        'skill_val'   => __( '70', 'eventcon-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'Interaction design', 'eventcon-companion' ),
                        'skill_val'   => __( '45', 'eventcon-companion' ),
                    ],
                ]
            ]
		);
     ...
     */
        ...
        $this->start_controls_section(
            'style_features_section', [
                'label' => __( 'Style Features Section', 'eventcon-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'BG Styles', 'eventcon-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'sec_bg_color', [
                'label' => __( 'Bg Color', 'eventcon-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
