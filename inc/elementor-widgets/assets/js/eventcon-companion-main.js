(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".eventcon-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".eventcon-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".eventcon-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.eventcon-eventcon').imagesLoaded(function () {
            // filter items on button click
            $('.eventcon-menu').on('click', 'p', function () {
            ...
            // init Isotope
            var $grid = $('.eventcon-eventcon').isotope({
    ...
    $('.eventcon-menu button.btn').on('click', function () {
        $('.eventcon-menu button.btn').removeClass('active');
    ...
    // MC Scripts
    var $subscribe = $('.eventcon-subscribe-newsletter-area');
    if ($subscribe.length) {
