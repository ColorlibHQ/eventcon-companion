...
class Eventcon_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'eventcon_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Eventcon ] Social Links', 'eventcon-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'eventcon-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'eventcon-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'eventcon-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'eventcon-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'eventcon-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'eventcon-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'eventcon-companion'); ?></label>
...
} // Class eventcon_social_links ends here


// Register and load the widget
function eventcon_social_links_widget_load() {
	register_widget( 'Eventcon_social_links' );
}
add_action( 'widgets_init', 'eventcon_social_links_widget_load' );